...
object Test06_ConstructorParams {
  def main(args: Array[String]): Unit = {
    ...
    val student2_1 = new Student2
    student2_1.name = "chenchi"
    student2_1.age = 32
    println(s"student2: name = ${student2_1.name}, age = ${student2_1.age}")

    val student3 = new Student3("bob", 20)
    println(s"student3: name = ${student3.name}, age = ${student3.age}")

//    val student4 = new Student4("cary", 25)
//    println(s"student4: name = ${student4.name}, age = ${student4.age}") // error, name and age are private
//    student4.printInfo()
    ...
    val student6 = new Student6("cary", 25, "东北大学")
